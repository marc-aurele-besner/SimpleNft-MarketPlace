...
contract SimpleNftMarketplace is Controlable, ListingManager, ValidateSignature {
    ...
    function createListing(address tokenContract, uint256 tokenId, uint256 salePrice, address seller, uint8 r, bytes32 s, bytes32 v) external returns (uint256 listingId) {
